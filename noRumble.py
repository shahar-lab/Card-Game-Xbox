...
def mainNoRumble(dataFile):
    ...
    # Random Walk for 200 trails and Reward Stimuli
    ...
    for t in range(1, n+1):
        ...
        #if (Math.random() < FB_matrix[stim_ids[second_selected]]
        if (random() < curr_prob):
            won.draw()
